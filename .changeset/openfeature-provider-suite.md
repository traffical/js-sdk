---
"@traffical/openfeature-core": minor
"@traffical/openfeature-server": minor
"@traffical/openfeature-web": minor
---

Initial release of the Traffical OpenFeature provider suite: a server (dynamic-context) provider backed by `@traffical/node`, a web (static-context) provider backed by `@traffical/js-client`, and the shared `@traffical/openfeature-core` translation layer they both build on.
